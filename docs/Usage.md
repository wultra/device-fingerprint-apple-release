...
```
wget https://wultra.jfrog.io/artifactory/device-fingerprint-apple-release/WultraDeviceFingerprint-0.0.6.xcframework.zip
unzip WultraDeviceFingerprint-0.0.6.documentation.zip -d Documentation
```