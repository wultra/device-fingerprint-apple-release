...
```
wget https://wultra.jfrog.io/artifactory/device-fingerprint-apple-release/WultraDeviceFingerprint-0.0.4.xcframework.zip
unzip WultraDeviceFingerprint-0.0.4.documentation.zip -d Documentation
```